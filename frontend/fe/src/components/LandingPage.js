...
// import logo from '../solve.png';  // Προσθήκη του λογότυπου
//
...
//                     <img src={logo} alt="solveME logo" style={{ width: '150px' }} />
...
//                     <div className="bg-secondary" style={{ height: '300px', backgroundColor: '#00A86B' }}>
//                         <h2 className="text-white">big solveME photo</h2>
//                     </div>
//                 </div>
//                 <div className="text-center mt-4">
//                     <a href="#" className="btn btn-secondary mx-2" style={{ backgroundColor: '#00A86B', borderColor: '#00A86B' }}>About</a>
//                     <a href="#" className="btn btn-secondary mx-2" style={{ backgroundColor: '#00A86B', borderColor: '#00A86B' }}>Demo</a>
//                     <a href="#" className="btn btn-secondary mx-2" style={{ backgroundColor: '#00A86B', borderColor: '#00A86B' }}>Instructions</a>
//                 </div>
//             </main>
//
